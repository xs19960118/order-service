...
@Configuration
@MapperScan(
        basePackages = "com.xs.boss.infrastructure.persistence.mapper.report",
...
public class ReportMyBatisConfig {
    ...
    public SqlSessionFactory reportSqlSessionFactory(@Qualifier("reportDataSource") DataSource dataSource) throws Exception {
        ...
        // 设置类型别名包路径
        sessionFactory.setTypeAliasesPackage("com.xs.boss.infrastructure.persistence.po.report");
