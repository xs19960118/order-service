...
/**
* @author xiangshang
* @description 针对表【case_productions】的数据库操作Mapper
* @createDate 2025-11-19 18:34:28
* @Entity generator.domain.CaseProductionsPO
*/
public interface CaseProductionsMapper extends BaseMapper<CaseProductionsPO> {
