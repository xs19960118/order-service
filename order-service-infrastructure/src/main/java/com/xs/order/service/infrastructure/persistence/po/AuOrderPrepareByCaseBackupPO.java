...
/**
 * 预处理订单
 * @TableName au_order_prepare_by_case_backup
 */
@TableName(value ="au_order_prepare_by_case_backup")
@Data
public class AuOrderPrepareByCaseBackupPO implements Serializable {
    /**
     * id
     */
    ...
    public boolean equals(Object that) {
        ...
        AuOrderPrepareByCaseBackupPO other = (AuOrderPrepareByCaseBackupPO) that;
