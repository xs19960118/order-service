...
/**
 * 预处理订单
 * @TableName au_order_prepare_by_case
 */
@TableName(value ="au_order_prepare_by_case")
@Data
public class AuOrderPrepareByCasePO implements Serializable {
    /**
     * id
     */
    ...
    public boolean equals(Object that) {
        ...
        AuOrderPrepareByCasePO other = (AuOrderPrepareByCasePO) that;
