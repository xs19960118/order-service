...
/**
 * 主数据-医生
 * @TableName bak_pds_doctors
 */
@TableName(value ="bak_pds_doctors")
@Data
public class BakPdsDoctorsPO implements Serializable {
    /**
     * id
     */
    ...
    public boolean equals(Object that) {
        ...
        BakPdsDoctorsPO other = (BakPdsDoctorsPO) that;
