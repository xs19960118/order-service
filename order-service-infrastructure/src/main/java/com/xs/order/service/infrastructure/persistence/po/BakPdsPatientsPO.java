...
/**
 * 主数据 - 患者
 * @TableName bak_pds_patients
 */
@TableName(value ="bak_pds_patients")
@Data
public class BakPdsPatientsPO implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        BakPdsPatientsPO other = (BakPdsPatientsPO) that;
