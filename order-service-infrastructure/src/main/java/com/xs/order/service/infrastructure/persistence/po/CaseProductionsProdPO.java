...
/**
 * 
 * @TableName case_productions_prod
 */
@TableName(value ="case_productions_prod")
@Data
public class CaseProductionsProdPO implements Serializable {
    /**
     * 自增id
     */
    ...
    public boolean equals(Object that) {
        ...
        CaseProductionsProdPO other = (CaseProductionsProdPO) that;
