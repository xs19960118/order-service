...
/**
 * 活动订单绑定表
 * @TableName ssa_order_binds
 */
@TableName(value ="ssa_order_binds")
@Data
public class SsaOrderBindsPO implements Serializable {
    /**
     * 自增id
     */
    ...
    /**
     * 活动编号  (sa_activity.code)
     */
    private String activityCode;

    /**
     * 订单编号 (orders.order_code)
     */
    private String orderCode;

    /**
     * 预购订单编号 (orders.order_code)
     */
    private String prepayOrderCode;

    /**
     * 绑定类型， 1.活动绑定， 2.预购对象绑定
     */
    ...
    public boolean equals(Object that) {
        ...
        SsaOrderBindsPO other = (SsaOrderBindsPO) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getPrepayOrderCode() == null ? other.getPrepayOrderCode() == null : this.getPrepayOrderCode().equals(other.getPrepayOrderCode()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPrepayOrderCode() == null) ? 0 : getPrepayOrderCode().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", prepayOrderCode=").append(prepayOrderCode);
