...
/**
 * 包裹明细加工表
 * @TableName standard_package_details
 */
@TableName(value ="standard_package_details")
@Data
public class StandardPackageDetailsPO implements Serializable {
    /**
     * 自增id
     */
    ...
    public boolean equals(Object that) {
        ...
        StandardPackageDetailsPO other = (StandardPackageDetailsPO) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getPackageItemCode() == null ? other.getPackageItemCode() == null : this.getPackageItemCode().equals(other.getPackageItemCode()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPackageItemCode() == null) ? 0 : getPackageItemCode().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", packageItemCode=").append(packageItemCode);
